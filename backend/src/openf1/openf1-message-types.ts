...
export type OpenF1MappedTopic = "v1/drivers" | "v1/position" | "v1/race_control" | "v1/weather";
...
export function isOpenF1MappedTopic(topic: string): topic is OpenF1MappedTopic {
  return topic === "v1/drivers" || topic === "v1/position" || topic === "v1/race_control" || topic === "v1/weather";
}
